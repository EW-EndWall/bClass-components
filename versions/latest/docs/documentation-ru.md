...
#### Модель 2 (4-точечные загрузчики)

- `.loader-m-2-1` — Последовательно масштабируемый 4-точечный загрузчик
- `.loader-m-2-2` — Увеличивающийся из углов 4-точечный загрузчик
- `.loader-m-2-3` — 4-точечный загрузчик с переходом Z-index и масштабированием
- `.loader-m-2-4` — Вращающийся и последовательно масштабируемый 4-точечный загрузчик (Модель 4)
- `.loader-m-2-5` — Вращающийся и последовательно масштабируемый 4-точечный загрузчик (Модель 5)
- `.loader-m-2-6` — Вращающийся на 120 градусов 4-точечный загрузчик
- `.loader-m-2-7` — Вращающийся на 180 градусов 4-точечный загрузчик
- `.loader-m-2-8` — Многонаправленный ступенчато вращающийся 4-точечный загрузчик
- `.loader-m-2-9` — Непрерывно вращающийся на 360 градусов 4-точечный загрузчик
- `.loader-m-2-10` — Быстро обратновращающийся многооборотный 4-точечный загрузчик
...
#### Модель 3 (2-точечные диагональные загрузчики)

- `.loader-m-3-1` — Вращающийся на 180 градусов 2-точечный диагональный загрузчик
- `.loader-m-3-2` — Многонаправленный ступенчато вращающийся 2-точечный диагональный загрузчик
- `.loader-m-3-3` — Вращающийся на 360 градусов 2-точечный диагональный загрузчик
- `.loader-m-3-4` — Быстро обратновращающийся многооборотный 2-точечный диагональный загрузчик
...
#### Модель 4 (SVG загрузчики с рамкой)

- `.loader-m-4-1` — Квадратный SVG загрузчик с рамкой (Длинная линия прогресса)
- `.loader-m-4-2` — Квадратный SVG загрузчик с рамкой (Средняя линия прогресса)
- `.loader-m-4-3` — Квадратный SVG загрузчик с рамкой (Короткая линия прогресса)
- `.loader-m-4-4` — Закругленный контурный SVG загрузчик с рамкой (Стандартное направление)
- `.loader-m-4-5` — Закругленный контурный SVG загрузчик с рамкой (Повернут на 90 градусов)
- `.loader-m-4-6` — Закругленный контурный SVG загрузчик с рамкой (Повернут на 180 градусов)
- `.loader-m-4-7` — Закругленный контурный SVG загрузчик с рамкой (Повернут на -90 градусов)
...
#### Модель 5 (SVG загрузчики без рамки)

- `.loader-m-5-1` — Квадратный SVG загрузчик без рамки (Длинная линия прогресса)
- `.loader-m-5-2` — Квадратный SVG загрузчик без рамки (Средняя линия прогресса)
- `.loader-m-5-3` — Квадратный SVG загрузчик без рамки (Короткая линия прогресса)
- `.loader-m-5-4` — Закругленный контурный SVG загрузчик без рамки (Стандартное направление)
- `.loader-m-5-5` — Закругленный контурный SVG загрузчик без рамки (Повернут на 90 градусов)
- `.loader-m-5-6` — Закругленный контурный SVG загрузчик без рамки (Повернут на 180 градусов)
- `.loader-m-5-7` — Закругленный контурный SVG загрузчик без рамки (Повернут на -90 градусов)
